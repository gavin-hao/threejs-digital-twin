<template>
  <LayoutScreen>
    ...
    <template #left v-if="showMask">
      <div class="panels">
        <Card title="状态1" backgroud>
          <div class="status-list col-2">
            <Status status="success" :frame="true" :title="'烧结炉'" key="sjl" @click="handleClickStatus('sjl')">
              <div>温度</div>
              1400.00℃
              <div>压力</div>
              834.00pa
        ...
        <Card title="状态2" backgroud>
          <div class="status-list col-3">
            <Status :frame="true" key="tjl" @click="handleClickStatus('tjl')">
              <div class="status">
                <div class="title">{{ '焦炭炉' }}</div>
                <div class="body">
                  <div>温度</div>
                  1639.00℃
                  <div>装煤量</div>
